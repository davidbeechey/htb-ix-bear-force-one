...
export default function GoalForm() {
    const validationSchema = Yup.object().shape({
        ...
        co2_index: Yup.number()
            .required("Co2 index goal is required")
            .min(400, "Must be greater than 400")
            .max(2500, "Must be less than 2500")
            .typeError(""),
        voc_index: Yup.number()
            .required("VoC index goal is required")
            .min(0, "Must be greater than 0")
            .max(500, "Must be less than 500")
            .typeError(""),
        energy_consumption: Yup.number()
            .required("Energy consumption goal is required")
            .min(0, "Must be greater than 0")
            .typeError(""),
        tds_index: Yup.number()
            .required("TDS index goal is required")
            .min(0, "Must be greater than 0")
            .max(500, "Must be less than 500")
            .typeError(""),
    });
                        ...
                        <div>
                            <div className="w-full flex flex-col mt-8">
                                ...
                                <textarea
                                    ...
                                    placeholder="Please include number of sensor packages needed at your university. Feel free to include any other details relevent to your sustainability project."
                                ></textarea>
                                <span className="text-red-500 text-sm">
                        ...
                        <div className="md:flex items-center mt-12">
                            <div className="w-full md:w-1/2 flex flex-col">
                                ...
                                <input
                                    ...
                                    type="number"
                                    className={`leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-gray-800 rounded ${
                                        errors.co2_index ? "is-invalid" : ""
                                    }`}
                                    placeholder="parts per million"
                                />
                                <span className="text-red-500 text-sm">
                                    {errors.co2_index?.message as string}
                                </span>
                            </div>
                            <div className="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                                <label className="font-semibold leading-none text-gray-300">
                                ...
                                <input
                                    ...
                                    type="number"
                                    className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-gray-800 rounded"
                                    placeholder="(0-500) range"
                                />
                                <span className="text-red-500 text-sm">
                                    {errors.voc_index?.message as string}
                                </span>
                            </div>
                        </div>
                        <div className="md:flex items-center mt-12">
                            <div className="w-full md:w-1/2 flex flex-col">
                                ...
                                />
                                <span className="text-red-500 text-sm">
                                    {errors.energy_consumption?.message as string}
                                </span>
                            </div>
                            <div className="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0 mt-4">
                                <label className="font-semibold leading-none text-gray-300">
                                ...
                                />
                                <span className="text-red-500 text-sm">
                                    {errors.tds_index?.message as string}
                                </span>
                            </div>
                        </div>
